...
type ExperimentStoreActions = {
  ...
  branchFromNode: (nodeId: ExperimentNodeId, manualPosition?: ExperimentManualPosition, branchDirection?: BranchDirection) => void
